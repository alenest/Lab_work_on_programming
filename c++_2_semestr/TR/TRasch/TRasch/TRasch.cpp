// TRasch.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
void main(int argc, char* argv[])
{
	...
	do {
		...
		case 'N': Matrix = CreateMatrix(ft, flog); break;
		...
		case 'D': MatrixFree(flog, &Matrix); break;
		case 'S': Search(flog, &Matrix); break;
