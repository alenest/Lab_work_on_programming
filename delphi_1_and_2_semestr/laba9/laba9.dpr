      ...
      try
       ...
       for i := 1 to n1 do
        begin
          ...
          writeln(answer);
          //тут выводим
          if ObcsheeUslovie then writeln(answer, 'В каждой строке массива есть ХОТЯ БЫ ОДИН нулевой элемент')
          else  begin writeln(answer, 'НЕ в каждой строке массива есть хотя бы один нулевой элемент') ;
                writeln(answer,'Первая строка без нулевых элементов: ', ibeznul ) ;  end;
