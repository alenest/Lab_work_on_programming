...
begin
    ...
    append(answer);
     ...
     begin
         ...
         begin
             writeln(answer, 'элемент матрицы ', q , ' строки и ', w, ' столбца, а именно: ',a[q][w]:3:3);
         ...
         begin
            ...
            begin
              summa :=   PoiskSumVerhDiag(N, A);
               writeln(answer, 'Сумма элементов матрицы на верхней диагонали и над нею: ', summa:3:3);
            end;
         end;
