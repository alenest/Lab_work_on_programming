...
begin
                ...
                readln(test,A);
                B:=A;
                writeln(answer,'--------------------------------------------------------'+#13#10 + 'строка: ', A);
                writeln(answer,#13#10 + 'Методом пузырька: ');
                writeln(answer,#13#10 + 'Ваша строка: ', A);
               ...
               begin
                ...
                writeln(answer, #13#10 +'Методом выбора: ');
                writeln(answer, #13#10 +'Ваша строка: ', B);

               for i := length(b) downto 2 do
               begin
                       m:=i; //ВОТ ЭТО ПРОСМОТРЕТЬ
                      ...
                      begin
                            ...
                            if ((Ord(B[u]) >= 97) and (Ord(B[u]) <= 122)) or((Ord(B[u]) >= 224) and (Ord(B[u]) <= 255))
                            then kodsuchetreg1:= ((Ord(B[u]) - 32) +0.5)
                            else if(Ord(B[u]) = 168) then kodsuchetreg1:= (ord('Е')+0.6)
                            else if(Ord(B[u]) = 184) then kodsuchetreg1:= ord('Е')+0.7
                            else kodsuchetreg1:= Ord(B[u]);


                            if ((Ord(B[m]) >= 97) and (Ord(B[m]) <= 122)) or((Ord(B[m]) >= 224) and (Ord(B[m]) <= 255))
                            then kodsuchetreg2:= ((Ord(B[m]) - 32) +0.5)
                            else if(Ord(B[m]) = 168) then kodsuchetreg2:= (ord('Е')+0.6)
                            else if(Ord(B[m]) = 184) then kodsuchetreg2:= (ord('Е')+0.7)
                            else kodsuchetreg2:= Ord(B[m]);
